 ...
 * Taking the wrapper off percentage heights makes Gecko content-size the row exactly like Blink, and measurably changes nothing in Blink, so it ships to both rather than sniffing the engine.
 */

/** The editor wrapper inside the approval form's body cell. */
